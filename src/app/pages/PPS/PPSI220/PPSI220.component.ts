  ...
  formatDataForExcel(_displayData) {
    ...
    for (let item of _displayData) {
      ...
      _.extend(obj, {
        ...
        DATE_CREATE: this.AppComponet.dateFormat(_.get(item, "DATE_CREATE"), 1),
        ...
        EPST: this.AppComponet.dateFormat(_.get(item, "EPST") ,1),
        LPST: this.AppComponet.dateFormat(_.get(item, "LPST") ,1),
        JIT: _.get(item, "JIT"),
        ...
        NEW_EPST: this.AppComponet.dateFormat(_.get(item, "NEW_EPST"), 1),
        NEWL_PST: this.AppComponet.dateFormat(_.get(item, "NEW_LPST"), 1),
        ...
        PLAN_DATE_I: this.AppComponet.dateFormat(_.get(item, "PLAN_DATE_I"), 1),
        PLAN_DATE_O: this.AppComponet.dateFormat(_.get(item, "PLAN_DATE_O"), 1),
        ...
        CREATE_DATE: this.AppComponet.dateFormat(_.get(item, "CREATE_DATE"), 1),
        FIX_EPST: this.AppComponet.dateFormat(_.get(item, "FIX_EPST"), 1),
