...
@Component({
  selector: 'app-PPSI105_NonBar',
  templateUrl: './PPSI105_NonBar.component.html',
  styleUrls: ['./PPSI105_NonBar.component.scss'],
  providers: [NzMessageService],
})
export class PPSI105_NonBarComponent implements AfterViewInit {
  LoadingPage = false;
