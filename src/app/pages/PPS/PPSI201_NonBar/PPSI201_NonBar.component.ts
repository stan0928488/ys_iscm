...
@Component({
  selector: 'app-PPSI201-NonBar',
  templateUrl: './PPSI201_NonBar.component.html',
  styleUrls: ['./PPSI201_NonBar.component.scss'],
  providers: [NzMessageService]
})
export class PPSI201NonBarComponent implements AfterViewInit {
