...
@Component({
  selector: "app-PPSI204_NonBar",
  templateUrl: "./PPSI204_NonBar.component.html",
  styleUrls: ["./PPSI204_NonBar.component.scss"],
  providers:[NzMessageService]
})
export class PPSI204_NonBarComponent implements AfterViewInit {
  LoadingPage = false;
