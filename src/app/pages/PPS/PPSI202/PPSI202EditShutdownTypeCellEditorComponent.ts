...
@Component({
    selector: 'ppsi202-edit-shutdown-type-cell-editor-component',
    template: `
         <nz-select 
            style=" margin-left:10px; margin-right:10px; width:120px;" 
            nzShowSearch  
            nzPlaceHolder="停機模式" 
            [(ngModel)]="params.data.MODEL_TYPE" >
...
export class PPSI202EditShutdownTypeCellEditorComponent implements ICellEditorAngularComp {
    ...
    getValue() {
        return this.params.data.MODEL_TYPE
    }
}