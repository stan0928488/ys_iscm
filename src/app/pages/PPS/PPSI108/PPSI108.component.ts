...
export class PPSI108Component implements AfterViewInit {
  ...
  insertSave() {
    ...
    return new Promise((resolve, reject) => {
      ...
      myObj.PPSService.insertI108Save('1', obj).subscribe(
        (res) => {
          console.log(res);
          if (res[0].MSG === 'Y') {
  ...
  updateSave(_id) {
    ...
    return new Promise((resolve, reject) => {
      ...
      myObj.PPSService.updateI108Save('1', obj).subscribe(
        (res) => {
          if (res[0].MSG === 'Y') {
            this.SHOP_CODE_8 = undefined;
            this.EQUIP_CODE_8 = undefined;
            ...
            const index = this.PPSINP08List.findIndex(
              (item) => item.id === _id
            );
  ...
  delID(_id) {
    ...
    return new Promise((resolve, reject) => {
      ...
      myObj.PPSService.delI108Data('1', _ID).subscribe(
        (res) => {
          if (res[0].MSG === 'Y') {
            this.SHOP_CODE_8 = undefined;
            this.EQUIP_CODE_8 = undefined;
  ...
  importExcel(_data) {
    ...
    return new Promise((resolve, reject) => {
      ...
      myObj.PPSService.importI108Excel('1', obj).subscribe(
        (res) => {
